...
func (h *Handler) RequestGeminiCLIToken(c *gin.Context) {
	...
	if geminiAuth.ClientID == "" || geminiAuth.ClientSecret == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "gemini OAuth client credentials are not configured; set CPA_PRO_GEMINI_OAUTH_CLIENT_ID and CPA_PRO_GEMINI_OAUTH_CLIENT_SECRET"})
		return
	}
