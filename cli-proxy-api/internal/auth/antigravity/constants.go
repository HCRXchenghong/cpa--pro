...
// OAuth client credentials are intentionally supplied at runtime.
var (
	ClientID     = strings.TrimSpace(os.Getenv("CPA_PRO_ANTIGRAVITY_OAUTH_CLIENT_ID"))
	ClientSecret = strings.TrimSpace(os.Getenv("CPA_PRO_ANTIGRAVITY_OAUTH_CLIENT_SECRET"))
)
